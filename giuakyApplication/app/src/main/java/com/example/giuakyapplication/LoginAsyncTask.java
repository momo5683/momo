...
public class LoginAsyncTask extends AsyncTask<String,Boolean, JSONObject> {
    ...
    public LoginAsyncTask(Context context,ILogin iLogin,Map<String,String> map){
        this.mMap = map;
        this.mLogin = iLogin;
    ...
    protected void onPreExecute() {
        ...
        dialog.setTitle("Hirai Momo sieu dep, please wait .....");
        dialog.show();
    }
    ...
    protected void onPostExecute(JSONObject jsonObject) {
        if (jsonObject != null){
            try {
                ...
                if (mResult > 0){
                    mLogin.onLoginSuccess(mMessage);
                }
                else{
                    mLogin.onLoginFail(mMessage);
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
